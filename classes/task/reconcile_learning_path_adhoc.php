...
class reconcile_learning_path_adhoc extends \core\task\adhoc_task {
    ...
    public function execute(): void {
        ...
        try {
            $affected = reconciler::reconcile_learning_path($learningpathid);
            task_log::record('reconcile', $learningpathid, (int) $affected);
        } catch (\Throwable $e) {
            task_log::record('reconcile', $learningpathid, 0, 'failed', $e->getMessage());
            throw $e;
        }
    }
}
