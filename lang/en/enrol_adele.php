...
$string['manage_intro'] = 'Every ADELE enrolment instance, one row per learning path and course. Filter the list to find a specific one, and use the per-row action to reconcile that learning path on demand — the nightly task already does this for all of them. Removing everything a learning path created is offered once the list is narrowed to a single learning path.';
...
$string['manage_tasks_action'] = 'Repair';
$string['manage_tasks_finished'] = 'Finished';
$string['manage_tasks_heading'] = 'Background repairs';
$string['manage_tasks_nextrun'] = 'Next attempt';
$string['manage_tasks_none'] = 'No repairs are currently queued.';
$string['manage_tasks_outcome'] = 'Outcome';
$string['manage_tasks_outcome_failed'] = 'Failed';
$string['manage_tasks_outcome_succeeded'] = 'Succeeded';
$string['manage_tasks_recent'] = 'The most recent completed repairs. A task disappears from the queue once it finishes, so this is the only place its outcome is recorded.';
$string['manage_tasks_state'] = 'State';
$string['manage_tasks_state_queued'] = 'Queued';
$string['manage_tasks_state_retrying'] = 'Failed, will be retried';
$string['manage_tasks_state_running'] = 'Running';
