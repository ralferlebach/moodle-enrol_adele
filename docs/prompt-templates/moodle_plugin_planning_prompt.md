<!--
Projektkontext (ADELE-Ökosystem, enrol_adele/local_adele/mod_adele):
Diese Vorlage ist bewusst generisch gehalten und unverändert aus dem
projektübergreifenden Vorlagenbestand übernommen -- sie eignet sich für die
Planung eines KOMPLETT NEUEN Moodle-Plugins von Grund auf. Für das laufende
ADELE-Ökosystem selbst ist sie nicht direkt anzuwenden (die drei Plugins
sind bereits weit fortgeschritten, siehe docs/lastenheft.md,
docs/pflichtenheft.md, docs/arbeitsplan.md); nuetzlich bliebe sie, sollte
das Projekt um ein VIERTES, eigenstaendiges Plugin erweitert werden.
-->
